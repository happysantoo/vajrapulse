 ...
 * 
 * <p><strong>Deprecated:</strong> This interface is deprecated. Use {@link com.vajrapulse.api.task.TaskLifecycle} instead.
 ...
 * {@link com.vajrapulse.api.task.TaskLifecycle} directly.
 * 
 * @see com.vajrapulse.api.task.TaskLifecycle
...
public interface Task extends com.vajrapulse.api.task.TaskLifecycle {
     ...
     * 
     * <p>This method maps to {@link com.vajrapulse.api.task.TaskLifecycle#init()}.
     * 
     * @throws Exception if setup fails
     * @deprecated Use {@link com.vajrapulse.api.task.TaskLifecycle#init()} instead
     */
    @Deprecated(since = "0.9.5", forRemoval = true)
     ...
     * 
     * <p>This method maps to {@link com.vajrapulse.api.task.TaskLifecycle#execute(long)} (iteration parameter ignored).
     * 
     * @return the result of the execution
     * @throws Exception if execution fails
     * @deprecated Use {@link com.vajrapulse.api.task.TaskLifecycle#execute(long)} instead
     */
    @Deprecated(since = "0.9.5", forRemoval = true)
     ...
     * 
     * <p>This method maps to {@link com.vajrapulse.api.task.TaskLifecycle#teardown()}.
     * 
     * @throws Exception if cleanup fails
     * @deprecated Use {@link com.vajrapulse.api.task.TaskLifecycle#teardown()} instead
     */
    @Deprecated(since = "0.9.5", forRemoval = true)
     ...
     */
    @Override
    default com.vajrapulse.api.task.TaskResult execute(long iteration) throws Exception {
        return execute();
    }
