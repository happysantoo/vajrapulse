...
- **NEVER merge PRs without explicit user approval** - Always wait for user confirmation before merging any pull request, no matter how complete or tested the code is
