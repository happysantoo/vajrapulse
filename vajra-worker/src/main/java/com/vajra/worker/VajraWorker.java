...
import com.vajra.api.RampUpLoad;
import com.vajra.api.RampUpToMaxLoad;
import com.vajra.api.StaticLoad;
import com.vajra.api.Task;
import com.vajra.core.engine.ExecutionEngine;
import com.vajra.core.metrics.AggregatedMetrics;
import com.vajra.core.metrics.MetricsCollector;
import com.vajra.exporter.console.ConsoleMetricsExporter;
...
/**
 * Main entry point for Vajra load testing worker.
 * 
...
@Command(
    name = "vajra",
    description = "Vajra Load Testing Framework",
    mixinStandardHelpOptions = true,
    version = "1.0.0-SNAPSHOT"
)
public final class VajraWorker implements Callable<Integer> {
    private static final Logger logger = LoggerFactory.getLogger(VajraWorker.class);
    ...
    public Integer call() throws Exception {
        logger.info("Vajra Load Testing Framework starting...");
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new VajraWorker()).execute(args);
